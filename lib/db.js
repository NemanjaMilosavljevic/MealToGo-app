...
export const checkIfMealIsInCard = (mealId) => {
  return db.prepare(`SELECT * FROM card WHERE EXISTS id = ?`).get(mealId);
};
...
export const getUsers = () => {
  return db
    .prepare(`SELECT * FROM users WHERE email != 'admin@admin.com'`)
    .all();
};
